...
export function UserAttendanceModal({ userId, userName, isOpen, onClose }: UserAttendanceModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => { if (!open) onClose(); }}>
      <DialogContent className="max-w-4xl max-h-[88vh] flex flex-col p-0 overflow-hidden border-gray-800 bg-[#12131a]/95 backdrop-blur-md text-white">
        {/* Sticky Top Header */}
        <div className="p-6 pb-4 border-b border-gray-800/80 shrink-0">
          <DialogHeader>
            <DialogTitle className="text-xl font-black font-headline uppercase tracking-tight">Attendance Ledger: {userName}</DialogTitle>
