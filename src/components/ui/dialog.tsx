        ...
        <div className={cn("mx-auto w-full h-full flex flex-col relative", (isTopPanel || isLeftPanel) ? "max-w-7xl" : "")}>
            ...
            <DialogPrimitive.Close className={cn(
                ...
                isTopPanel 
                  ...
                  : isLeftPanel
                  ? "right-4 top-1/2 -translate-y-1/2 p-4 bg-primary text-primary-foreground border-4 border-background h-16 w-16 flex items-center justify-center translate-x-1/2"
                ...
                {isTopPanel ? <ChevronUp className="h-8 w-8" /> : isLeftPanel ? <ChevronLeft className="h-8 w-8" /> : <X className="h-4 w-4" />}
